...
export default function SabahAvatar() {
  ...
  function onLoad(spline) {
    ...
    const obj_linkedin = spline.findObjectById(
      "9c912aab-9668-4e54-b615-636471ae2e08"
    );
    const obj_instagram = spline.findObjectById(
      "eeca5104-564b-4330-ad6c-a0aef8ce0051"
    );
    const obj_github = spline.findObjectById(
      "40579ff5-b702-4d01-8f93-6f3340f16692"
    );
